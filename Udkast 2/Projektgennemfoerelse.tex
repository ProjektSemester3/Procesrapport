...
\subsubsubsection*(Roller)
Product owner rollen blev uddelegeret på hele gruppen, og alle var ansvarlig for oprettelse af issues på backloggen.   
\subsubsubsection*(Sprints)
\subsubsubsection*(Møder)
\subsubsubsection*()

\subsubsection*(Fordele/ulemper)
\subsubsubsection*(Psykologiske effekter)
\subsubsubsection*(Kontrol)
\subsubsubsection*(Struktur)
...
\subsubsubsection*(Fravær)
\subsubsubsection*(Engagement)
\subsubsubsection*(Udmelding)
\subsubsubsection*(Håndtering)
